...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: brown;    border-top: 2px solid black;}
    ...
    /* Copy Right Footer */
    .footer-copyright {	background-color: pink;	padding: 5px 0;box-shadow: -1px -1px 3px black;border-top:1px solid black;}
    ...
    footer.light .footer-copyright{	background: none repeat scroll 0 0 rgba(300, 250, 150, 3.3) ;}
...
<footer style = "font-size : 18px;" id="footer" class="footer-1">
    ...
    <li>
    <div class="thumb-content"><a href="">COE Notifications</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="">Rules & Regulation</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="">Results</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="">Malpractice Rules & Regulations</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="">About</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a  href="" target="_blank">Contact Us</a></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <li><a  href="" target="_blank">Education Videos</a></li>
    <li><a  href="" target="_blank">Newsletters</a></li>
    <li><a  href="" target="_blank">COE office</a></li>
    <li><a  href="" target="_blank">CSE Dept</a></li>
    <li><a  href="" target="_blank">Calendar Of Events</a></li>
    ...
    <p style= "color : #D0D3D4;"><a href=" title="glorythemes" style="color:orange;"><i class='far fa-envelope' style='font-size:14px'></i> info@fmnc.ac.in</a></p>
    <p><i class='fas fa-phone-square'></i> +91-90481218115</p>
    ...
    <p style = "font-family:'PT serif';color:grey;">All Rights Reserved By FMNC. Powered by FATIMA IT Solutions.</p>
    </div>
    </div>
    </div>
    </div>
